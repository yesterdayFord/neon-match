...
pub const CommandEvent = exchange.CommandEvent;
pub const InstrumentId = exchange.InstrumentId;
pub const default_instrument_id = exchange.default_instrument_id;
pub const max_instruments = exchange.max_instruments;
pub const InstrumentedOrder = exchange.InstrumentedOrder;
pub const InstrumentedCancel = exchange.InstrumentedCancel;

const BookSet = exchange.BookSet;
const CommandResult = exchange.CommandResult;
const appendJournalEvent = exchange.appendJournalEvent;
const commandEventFromJournalRecord = exchange.commandEventFromJournalRecord;
const commandEventInstrumentId = exchange.commandEventInstrumentId;
const applyCommandEventStructured = exchange.applyCommandEventStructured;
const instrumentIndex = exchange.instrumentIndex;
